...
class Form2(models.Model):
    ...
    form2_POrg = models.CharField(max_length=50, null=True, blank=True)
    form2_PGrp = models.CharField(max_length=50, null=True, blank=True)
    form2_target_value = models.PositiveIntegerField(null=True, default=None)
    form2_currency = models.CharField(max_length=20, null=True, blank=True)
