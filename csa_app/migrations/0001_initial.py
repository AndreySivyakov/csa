# Generated by Django 2.1 on 2020-03-12 23:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('form2_parent_field_ref', models.IntegerField(default=None, null=True)),
                ('form2_contr_num', models.BigIntegerField(default=None, null=True)),
                ...
                ('form2_target_value', models.BigIntegerField(default=None, null=True)),
                ...
                ('form2_plant_location', models.CharField(blank=True, max_length=100, null=True)),
                ('form2_lock_unlock', models.CharField(blank=True, max_length=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Form5',
